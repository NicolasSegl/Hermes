...
private:
    ...
    Byte sra(Byte val);        // shift value to the right, and preserve the sign of the value
    Byte sla(Byte val);        // shift value to the left, and preserve the sign of the value
